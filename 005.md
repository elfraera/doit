...
IMHO, the most significant f*ing problem of Ruby is “Just because version X works fine;
...
Take it or leave it. And, you have been warned!
...
```
* You might "cut and paste" that file or fetch it with:
...
```
* Your need to have SuperUser (root) privilege ("su -" or "sudo su -") to replace the "sources.list" file.
...
```
* Your need to have SuperUser (root) privilege ("su -" or "sudo su -") to run the script.
...
* URL: <https://doit.vlsm.org/assets/scripts/debs.sh>
